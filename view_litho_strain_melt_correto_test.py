...
for cont in range(step_initial, step_final, d_step):  #
    ...
    plt.contour(xx,zz,Temperature,levels=[500,1000,1300],colors="k")

    plt.contourf(xx,zz+h_air,Phi,levels=[0.2,0.6],colors="k",alpha=0.3)

    plt.contour(xx,zz+h_air,dPhi/1.0E4,levels=[1.0E-10],colors="r")
    ...
    plt.savefig("Melt_Test_litho_new_temper_{:05}.png".format(cont * 1))
